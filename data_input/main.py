...
import get_data
import transform.get_transform_details as get_details
...
if __name__ == '__main__':
    ...
    # get_Data.get_data_from_git(collection_patient)

    print("\n=============USER DETAILS=========================================")
    # Get an individual's personal details
    user = get_details.find_user("Aaron697", "Dickens475",  collection_patient)
    print(user.to_string())

    print("\n=============USERS FROM SAME CITY==================================")
    # Get all users from a same state
    user_by_city = get_details.get_all_user_by_city('Boston', collection_patient)
    ...
    user_diag_report = get_details.get_user_diagnostic_report("Aaron697", "Dickens475", collection_patient)
    ...
    user_claim_report, agg_report = get_details.get_user_claim_report("Aaron697", "Dickens475", collection_patient)
    ...
    print("\n=============USER ANALYTICS===========================")
    user_group_report = get_details.count_based_on_gender(collection_patient)
    print(user_group_report.to_string())
    user_city_report = get_details.count_based_on_city(collection_patient)
